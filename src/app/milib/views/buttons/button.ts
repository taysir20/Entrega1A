...
export class Button extends View {
    ...
    private viewFalse: View;
    private viewTrue: View;
    ...
    constructor(vMotor:Motor, vX:number, vY:number, vW:number, vH:number){
        ...
        this.lblTexto=new Label(this.motor,0,-this.h/4,this.w,this.h);
        this.lblTexto.setTexto("Boton");
        this.lblTexto.setFontStyle("45px Minecraft");
        this.lblTexto.setFontColor("#497925");
    ...
    /*
    public setViewVisible(viewFalse:View, viewTrue:View):void{
       
        this.viewFalse=viewFalse;
        this.viewTrue=viewTrue;
    }
    */
    /*
    public click():void{
        
        this.motor.setViewVisibility(this.viewFalse.uid, false);
        this.motor.setViewVisibility(this.viewTrue.uid, true);
